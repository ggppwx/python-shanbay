...
client_id = '81a6ae25f60e34f7c351'
client_secret = '0a3ac447da41bcd207758d4d2838f08ec9f2a92a'
redirect_uri = 'https://github.com/ggppwx/python-shanbay'
...
def get_token():
    ...
    print ( 'Please go here and authorize, {0}'.format(authorization_url) )
...
try:
    ...
    TokenExpiredError, TokenUpdated, OAuth2Error, FatalClientError, ValueError, IOError
) as e:
    api = get_token()
    userinfo(api)